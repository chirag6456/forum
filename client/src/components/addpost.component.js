...
export default class AddPostComponent extends Component {
    ...
    handleSubmit(event){
        ...
        const data = {
            postcategory : this.props.match.params.id,
        ...
        axios.post('/api/posts/add/', data, config).then( response => {
        ...
        return (
            <div>
                    <form style={{ marginLeft : "20rem", marginTop : "10rem", maxWidth: "25rem"} } onSubmit={this.handleSubmit}>
                        ...
                        <button type="submit" className="btn btn-success">Add Post</button><br/><br/>
